...
import { ArrowLeftIcon, CheckIcon, GlobeIcon, LinkIcon, LockIcon, UsersIcon } from 'lucide-react'
                ...
                >
                    <div className="px-5 pb-8 pt-2">
                        <p className="text-sm leading-5 text-content-secondary">
                            {owner ? (
                                <>
                                    그룹장이 나가면 {detail.name}이 사라지고, 참여자 모두가 함께 나가게 돼요. 도감을
                                    남기고 싶다면 도감 관리에서 먼저 그룹장을 넘겨 주세요.
                                </>
                            ) : (
                                <>나가면 카드를 더 등록할 수 없어요. 초대 코드를 다시 받으면 들어올 수 있어요.</>
                            )}
                        </p>
