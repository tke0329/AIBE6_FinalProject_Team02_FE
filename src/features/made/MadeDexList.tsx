    ...
    <div className="relative flex h-full flex-col bg-cream-100">
      ...
      <main className="no-scrollbar flex-1 overflow-y-auto px-5 py-4">
        ...
        {loading ? (
          ...
          <div className="space-y-3">
            ...
            {dexes.length === 0 && !error && (
              <div className="flex min-h-40 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-edge-default bg-cream-50 text-center">
        ...
        <div className="mt-4 flex items-start gap-2 rounded-2xl bg-cream-200 p-3 text-xs text-content-muted">
          ...
          />
          초대 코드로 참여하면 함께 카드를 등록할 수 있어요. 한 도감에 최대
          12명까지 모일 수 있어요.
        </div>
      </main>
