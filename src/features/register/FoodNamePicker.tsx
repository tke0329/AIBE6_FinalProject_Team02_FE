        ...
        <section className="mt-6" aria-label="음식 이름 고르기">
            <div className="mb-1.5 flex items-center justify-between">
                <label className="text-sm font-medium text-content-secondary" htmlFor="dex-search">
                    음식 이름을 입력해 주세요 <span className="text-content-link">(필수)</span>
                </label>
            ...
            {selectedSlots.length > 0 && (
                <ul className="no-scrollbar -mx-5 mb-2 flex gap-1.5 overflow-x-auto px-5" aria-label="고른 음식">
            ...
            {canAddMore && !searching && (
                <div className="mt-3">
                    <div className="mb-2 flex flex-wrap items-center gap-x-1.5 gap-y-0.5">
                        ...
                        <h3 className="text-xs font-bold text-content-primary">도감 둘러보기</h3>
                        <p className="text-xs text-content-secondary">(카테고리를 눌러서 도감 목록을 확인해 보세요!)</p>
                    </div>
