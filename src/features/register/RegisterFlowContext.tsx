...
import { MAX_PHOTOS, requestUploadTargets, uploadPhotoToS3, validatePhotoFile } from './uploadApi'
...
export function RegisterFlowProvider({ children }: { children: React.ReactNode }) {
    ...
    const uploadedPhotoKeys = useMemo(() => uploadedPhotos.map((photo) => photo.key), [uploadedPhotos])
