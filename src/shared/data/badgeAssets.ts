 ...
 */
export function resolveBadgeImage(code: string | null | undefined, imageUrl: string | null | undefined): string | null {
...
/** 보관함 섹션 표시 순서 */
export const BADGE_GROUP_ORDER: BadgeGroup[] = ['CHALLENGE', 'MADE_DEX', 'SPOON', 'CATEGORY', 'ETC']
