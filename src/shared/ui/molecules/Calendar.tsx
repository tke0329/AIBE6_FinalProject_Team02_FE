    ...
    return (
        <DayPicker
            ...
            classNames={{
                ...
                weekdays: 'flex pb-1',
                weekday: 'flex-1 text-xs font-medium text-content-muted',
                week: 'flex w-full',
                day: 'flex-1 py-1',
                day_button:
                    'flex h-10 w-full items-center justify-center rounded-full text-sm text-content-primary transition-colors active:scale-[0.98]',
                ...
                outside: 'opacity-40',
                disabled: '[&>button]:text-action-disabled-text',
                hidden: 'invisible',
